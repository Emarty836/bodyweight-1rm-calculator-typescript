...
let input1 = document.querySelector('#first') as HTMLInputElement;
let input2 = document.querySelector('#second') as HTMLInputElement;
let input3 = document.querySelector('#third') as HTMLInputElement;
const button1 = document.querySelector('#button1') as HTMLButtonElement;
var adding1 = document.querySelector('#add1') as HTMLButtonElement;
var adding2 = document.querySelector('#add2') as HTMLButtonElement;
var adding3 = document.querySelector('#add3') as HTMLButtonElement;
var minus1 = document.querySelector('#minus1') as HTMLButtonElement;
var minus2 = document.querySelector('#minus2') as HTMLButtonElement;
var minus3 = document.querySelector('#minus3') as HTMLButtonElement;
